...
public class ManageCustomersFormController {
    ...
    CustomerBO customerBO = (CustomerBO) BOFactory.getBoFactory().getBO(BOFactory.Types.CUSTOMER);
    ...
    private void loadAllCustomers() {
        ...
        try {
            ...
            for (CustomerDTO get : dto) {
                tblCustomers.getItems().add(new CustomerTM(get.getId(),get.getName(),get.getAddress()));
            }
    ...
    private void navigateToHome(MouseEvent event) throws IOException {
        URL resource = this.getClass().getResource("/lk/ijse/thogakade/view/main-form.fxml");
